...
import {
  auroraTitanSpaceShip,
  blueSpaceShip,
  createPlayerAuroraTitanSpaceShip,
  createPlayerBlueSpaceShip,
  createPlayerInterceptorAlphaSpaceShip,
  createPlayerWhiteSpaceShip,
  interceptorAlphaSpaceShip,
  whiteSpaceShip,
} from "../spawn-controller/player/player-assets.js";
...
export const handlePlayerSpaceshipSelect = (selectedSpaceship) => {
  ...
  switch (selectedSpaceship) {
    ...
    case "interceptor-alpha":
      gameVariables.playerSpaceShipPreview.appendChild(
        interceptorAlphaSpaceShip
      );
      gameVariables.spaceshipName = createPlayerInterceptorAlphaSpaceShip(
        interceptorAlphaSpaceShip
      );
      break;
    case "aurora-titan":
      gameVariables.playerSpaceShipPreview.appendChild(auroraTitanSpaceShip);
      gameVariables.spaceshipName =
        createPlayerAuroraTitanSpaceShip(auroraTitanSpaceShip);
      break;
  }
};
