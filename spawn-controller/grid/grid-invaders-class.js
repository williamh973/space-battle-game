...
export class Grid {
  constructor() {
    ...
    this.colums = Math.round(
      alienMinimumNumberInGrid +
        gameVariables.level / relativeValueForIncreaseAlienInColums
    );
    this.rows = Math.round(
      alienMinimumNumberInGrid +
        gameVariables.level / relativeValueForIncreaseAlienInRows
    );
    this.scale = 35;
    this.draw();
  }
