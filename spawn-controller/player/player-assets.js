...
export const interceptorAlphaSpaceShip = createPlayerInterceptorAlphaSpaceShip('./assets/images/player/interceptor-alpha.png');
...
export const auroraTitanSpaceShip = createPlayerAuroraTitanSpaceShip('./assets/images/player/aurora-titan.png');
